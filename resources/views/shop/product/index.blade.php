        ...
        <div class="col-7">
            <div id="carouselExampleControls" class="carousel slide">
                <div class="carousel-inner">
                    @foreach($product->images as $key => $item)
                        <div class="carousel-item {{$key === 0 ? 'active' : false}}">
                            <img src="{{asset('storage/images/'.$product['id'].'/'.$item['img'])}}" class="d-block w-100" alt="...">
                        </div>
                    @endforeach
                </div>
                ...
                <div class="carousel-indicators">
                    @foreach($product->images as $key => $item)
                    <img src="{{asset('storage/images/'.$product['id'].'/'.$item['img'])}}" data-bs-target="#carouselExampleControls" data-bs-slide-to="{{$key}}"
